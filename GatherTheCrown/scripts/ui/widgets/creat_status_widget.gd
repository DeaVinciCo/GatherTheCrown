...
func _draw() -> void:
	...
	# Blue heart placeholder icon beside segmented lane.
	draw_circle(Vector2(10, 28), 9.0, Color(0.21, 0.57, 0.95, 1.0))
	draw_circle(Vector2(20, 28), 9.0, Color(0.21, 0.57, 0.95, 1.0))
	draw_colored_polygon(PackedVector2Array([Vector2(2, 31), Vector2(28, 31), Vector2(15, 45)]), Color(0.21, 0.57, 0.95, 1.0))
