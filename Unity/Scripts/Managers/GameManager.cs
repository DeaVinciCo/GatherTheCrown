...
public class GameManager : MonoBehaviour
{
    ...
    public void ShowStats()
    {
        ...
        if (kingdomManager != null)
        {
            var stats = kingdomManager.GetStats();
            Debug.Log($"\n🏰 Kingdoms:");
            Debug.Log($"   Discovered: {stats.discovered}/8");
            Debug.Log($"   Vaults Cleared: {stats.vaultsCleared}/8");
            Debug.Log($"   Restored: {stats.restored}/8");
        }
    ...
    public void ChangeMode(GameMode newMode)
    {
        ...
        if (uiManager != null)
        {
            uiManager.UpdateModeUI(newMode);
        }
    }
